...
namespace Microsoft.AspNetCore.Server.Kestrel.Internal.Infrastructure
{
    public static class HttpUtilities
    {
        ...
        private readonly static ulong _httpSecureSchemeLong = GetAsciiStringAsLong(HttpSecureUriScheme);
        ...
        public static bool GetKnownHttpScheme(this Span<byte> span, out HttpScheme knownScheme)
        {
            if (span.TryRead<ulong>(out var value))
            {
                ...
                if (value == _httpSecureSchemeLong)
                {
                    knownScheme = HttpScheme.HttpSecure;
                    return true;
                }
            }
        ...
        public static string SchemeToString(HttpScheme scheme)
        {
            switch (scheme)
            {
                ...
                case HttpScheme.HttpSecure:
                    return HttpSecureUriScheme;
                default:
                    return null;
            }
        }
